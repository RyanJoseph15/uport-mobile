...
import { authorizeCamera, authorizeLocation, authorizeNotifications } from 'uPortMobile/lib/actions/authorizationActions'
...
export function* checkLocationPermissions () {
  ...
  yield put(authorizeLocation(permission))
}
