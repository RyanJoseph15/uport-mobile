...
import { checkCameraPermissions, checkLocationPermissions, checkNotificationsPermissions } from './permissionsSaga'
...
function * longerRunningStartupTasks (address) {
  ...
  yield call(checkLocationPermissions)
  ...
  try {
    ...
    if (address) {
      ...
      Permissions.request('location').then(response => {
          ...
          NativeModules.Counter.loadOnStartUp();
      })
