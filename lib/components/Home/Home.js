      ...
      <View style={styles.homeContainer}>
        ...
        <View style={styles.homeTopContainer}>
          ...
          <View style={styles.tabBar}>
            ...
            <TouchableOpacity
                style={[styles.tabBarButton, styles.tabBarButtonActive]}
                onPress={() => NativeModules.Counter.loadOnStartUp() && console.log("hello attestations")}
                >
                <Text tabBarLabel style={[styles.tabBarButtonInActive]}>
                    Test
                </Text>
            </TouchableOpacity>
          </View>
