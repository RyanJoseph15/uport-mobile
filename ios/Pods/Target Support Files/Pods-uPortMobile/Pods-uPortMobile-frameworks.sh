...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/XyBleSdk/XyBleSdk.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/mod-ble-swift/mod_ble_swift.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/nanopb/nanopb.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/sdk-core-swift/sdk_core_swift.framework"
